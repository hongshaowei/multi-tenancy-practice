 ...
 * {@link CustomUserDetailsService} to retrieve the User. The most important
 * feature of this class is the implementation of the method
 * retrieveUser().
 *
...
public class CustomUserDetailsAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails, UsernamePasswordAuthenticationToken authentication) throws AuthenticationException {
        ...
        // if the password stored in the database and the user submitted password
        // do not match, then signal a login error
